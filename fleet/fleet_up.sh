...
if [[ "$UCS_GAZEBO_BACKEND" == "docker" && "$WORLD_GUI" != "1" && "$UCS_GAZEBO_CAMERA_PROFILE_EXPLICIT" -eq 0 && "$GAZEBO_DOCKER_GPU_ENABLED" -eq 1 && "$TOPOLOGY_VIDEO_MAIN_ENABLED" == "1" ]]; then
...
export UCS_GAZEBO_CAMERA_PROFILE
